...
================================================== -->
  ...
  <nav class="navbar navbar-default navbar-fixed-top">
    ...
    <div class="row">
            ...
            {if $mensaje2 neq ""}<div class="alert alert-success" role="alert">{$mensaje2}</div>{/if}
            	
            <div class="panel panel-success">
              <div class="panel-heading">Ya estoy registrado</div>
                  <div class="panel-body">
                    <form class="form-horizontal" role="form" action="" method="post" name="form1" id="form2" onsubmit="MM_validateForm('nombre','','R','apellido','','R','telefono','','RisNum','email','','RisEmail','comentario','','R');return document.MM_returnValue">
                      <div class="form-group">
                      <label class="sr-only" for="login">Usuario</label>
                      <input  onkeypress="javascrip: return validarletrasnum(event);" type="text" class="form-control" name="login" id="login" placeholder="Usuario" value="{$nombre}">
                      </div>
                      <div class="form-group">
                      <label class="sr-only" for="clave">Clave</label>
                      <input  type="password" class="form-control" name="clave2" id="clave2" placeholder="Clave" value="{$clave}">
                      </div>
                      <input class="btn btn-md btn-success btn-block" name="enviar" type="submit" id="enviar" value="Entrar" />
                    </form>
                        
                        
                   <button type="button" class="btn btn-link">¿Olvidó su clave?</button>
            ...
            <div class="col-lg-6 col-md-6">
            <div class="panel panel-success">
              <div class="panel-heading">Soy nuevo usuario</div>
                  <div class="panel-body">
                   <p> Soy un nuevo cliente.</p>
                   <p>Al crear una cuenta en Díaz Creativos.net, podrá realizar la compra de nuestros productos vía web desde la comodidad de su casa. Además de acceder a las utilidades y herramientas de desarrollo que ofrecemos de forma gratuita.</p>   
                        
                   <button type="button" class="btn btn-md btn-success btn-block">Registrarse</button>
