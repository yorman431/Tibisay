				...
				<div class="col-md-4 col-xs-12">
					<div class="panel panel-default">
						<div class="panel-header text-center">
							<h4>{$portafolio[i].nombre_por}</h4>
						</div>
						<div class="panel-body padding-off">
							<img src="imagenes/{$portafolio[i].directorio_image}" class="img-responsive center-block">
						</div>
						<div class="panel-footer form-horizontal padding-off">
							<a href="portafolio_detalle.php?id={$portafolio[i].id_por}" class="btn btn-info btn-block">Ver M&aacute;s</a>
						</div>
					</div>
				</div>
			{/section}
