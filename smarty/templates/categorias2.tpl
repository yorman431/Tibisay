...
================================================== -->
  ...
  <nav class="navbar navbar-default navbar-fixed-top">
	...
	<!-- InstanceBeginEditable name="contenido" -->
        ...
        <div class="titulo_interno">Seleccione el formato deseado</div>
          <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="normal2">
                <tr>
                  <td align="center" valign="top">
                    ...
                    <tr> {section name=i loop=$listado}
                      ...
                      <table class="marco2" width="100%" border="0" cellpadding="0" cellspacing="2">
                        <tr>
                          <th align="center"><a class="diapo" href="/categorias.php?id={$listado[i].id_cat}#next">{$listado[i].nombre_cat}</a></th>
                        </tr>
                        <tr>
                          <td align="center" bgcolor="#333"><a href="/categorias.php?id={$listado[i].id_cat}#next" title="Ver m&aacute;s" > <img alt="{$listado[i].nombre_image}" border="0" src="/imagenes/miniaturas/{$listado[i].directorio_image}" width="150" longdesc="{$listado[i].descripcion_pro}" class="opacidad" /></a></td>
                        </tr>
                      </table></td>
                      {assign var="cont" value=$cont+1}
                      {if $cont eq 4}
