  ...
  <nav class="navbar navbar-default navbar-fixed-top">
	...
	<!-- InstanceBeginEditable name="contenido" -->
        ...
        <div class="row">
            ...
            <h2 class="featurette-heading">{$accion}</h2>
            ...
            <form class="form-horizontal" role="form" action="" method="post" name="form2" id="form2">
                  ...
                  <input  onkeypress="javascrip: return validarnum(event);" type="number" class="form-control" name="telefono" id="telefono" placeholder="Teléfono para contacto" value="{$telefono}">
                  </div>
                  <div class="form-group">
                    <label class="sr-only" for="correo">Correo</label>
                    <input  onkeypress="javascrip: return validarcorreo(event);" type="email" class="form-control" id="email" name="email" placeholder="Correo electrónico" value="{$email}">
                  </div>
                  <div class="form-group">
                    <label class="sr-only" for="comentario">Comentario</label>
                    <textarea class="form-control" rows="4" name="comentario" id="comentario" placeholder="Introduce tu mensaje">{$comentario}</textarea>
                  </div>
                  <div class="form-group">
                  
                  <input onclick="javascript: return validarformulario();" class="btn btn-md btn-info btn-block" name="envio" type="submit" value="Enviar" />
                  </div>
            </form>
            </div>
      ...
      <div class="col-lg-6 col-md-6">
          <blockquote>
            <address>
              <strong>Margarita's Camping</strong> 
              <br>Nueva Esparta | Venezuela<br/> 
            </address>
             
            <address>
              <strong>Departamento de Ventas</strong><br>
              <a href="mailto:contacto@diazcreativos.net.ve">margaritascamping@example.com</a>
            </address>
