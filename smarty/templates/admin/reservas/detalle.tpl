    ...
    <table width="98%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <table width="90%" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td align="left" class="subtituloWeb3">Drop Off:</td>
            <td class="adminContenido">{$dropoff}</td>
          </tr>
          <tr>
            <td align="left" class="subtituloWeb3">Adults:</td>
            <td class="adminContenido">{$adultos}</td>
          </tr>
          <tr>
            <td align="left" class="subtituloWeb3">Childs:</td>
            <td class="adminContenido">{$ninos}</td>
          </tr>
          </table>
        </td>
      </tr>
