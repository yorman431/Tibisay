...
<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0" class="marco">
    ...
    <td colspan="3"><!-- InstanceBeginEditable name="contenido" -->
      <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="normal">
        ...
        <tr>
          ...
          <td width="20%" class="subtituloWeb3">Reservation</td>
          <td width="20%" class="subtituloWeb3">Email</td>
          <td width="20%" class="subtituloWeb3">Date</td>
          <td width="10%" class="subtituloWeb3">Schedule</td>
          <td width="10%" class="subtituloWeb3">Telephone</td>
          <td width="15%" colspan="3" align="center" class="subtituloWeb3">Actions</td>
        </tr>
        {if $mensaje eq ""}
  ...
  <tr {if $cont eq '0'} class='listado_a'
    ...
    <td class="adminContenido">{$listado[i].reserva}</td>
    <td class="adminContenido">{$listado[i].correo}</td>
