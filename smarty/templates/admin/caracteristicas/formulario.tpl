...
<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0" class="marco">
          ...
          <tr>
            <td align="center" class="subtituloWeb3"><table width="42%" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <tr>
               ...
               <tr>
                <td align="left" class="subtituloWeb3">Portafolio Asociado:</td>
                <td align="left" class="normalContenido">
                <select id="car_portafolio" name="portafolio" size="1">
                      {section name=i loop=$portafolio}
                      <option value="{$portafolio[i].id_por}">{$portafolio[i].nombre_por}</option>
                      {/section}
                </select> 
                 *</td>
              </tr>
  ...
  <td>&nbsp;</td>
    <td align="left"><input name="envio" type="submit" class="componentes" id="button3" onclick="javascript: return confirm('&iquest;Est&aacute; seguro que desea guardar?');" value="Guardar" />
      &nbsp;&nbsp;
      <input name="button" type="button" class="componentes" id="button4" onclick="javascript: location.href='/admin/caracteristicas/'" value="Cancelar" /> <span class="normalContenido">(*) Datos Obligatorios</span></td>
  </tr>
            </table></td>
          </tr>
        </table>
