...
<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0" class="marco">
  ...
  <tr>
    <td align="left" class="subtituloWeb3">Engine:</td>
    <td align="left" class="normalContenido"><select name="motor" class="texto_gen" id="motor">
        <option {if $motor eq "3 Cylinder"} selected="selected"{/if} value="3 Cylinder">3 Cylinder</option>
        <option {if $motor eq "4 Cylinder"} selected="selected"{/if} value="4 Cylinder">4 Cylinder</option>
        <option {if $motor eq "5 Cylinder"} selected="selected"{/if} value="5 Cylinder">5 Cylinder</option>
        <option {if $motor eq "6 Cylinder"} selected="selected"{/if} value="6 Cylinder">6 Cylinder</option>
        <option {if $motor eq "8 Cylinder"} selected="selected"{/if} value="8 Cylinder">8 Cylinder</option>
        <option {if $motor eq "10 Cylinder"} selected="selected"{/if} value="10 Cylinder">10 Cylinder</option>
        <option {if $motor eq "12 Cylinder"} selected="selected"{/if} value="12 Cylinder">12 Cylinder</option>
        <option {if $motor eq ""} selected="selected"{/if} value="">&lt; Select Engine &gt;</option>
      </select> 
      *</td>
  </tr>
  <tr>
  ...
  <tr>
    <td align="left" class="subtituloWeb3">Fuel Type:</td>
    <td align="left" class="normalContenido"><select name="combustible" class="texto_gen" id="combustible">
        <option {if $combustible eq "Alternative"} selected="selected"{/if} value="Alternative">Alternative</option>
        <option {if $combustible eq "Diesel"} selected="selected"{/if} value="Diesel">Diesel</option>
        <option {if $combustible eq "Gasoline"} selected="selected"{/if} value="Gasoline">Gasoline</option>
        <option {if $combustible eq ""} selected="selected"{/if} value="">&lt; Select Fuel Type &gt;</option>
      </select> 
    *</td>
  </tr>
  <tr>
    <td align="left" class="subtituloWeb3">Doors:</td>
    <td align="left" class="normalContenido"><select name="puertas" class="texto_gen" id="puertas">
        <option {if $puertas eq "2"} selected="selected"{/if} value="2">2 Doors</option>
        <option {if $puertas eq "3"} selected="selected"{/if} value="3">3 Doors</option>
        <option {if $puertas eq "4"} selected="selected"{/if} value="4">4 Doors</option>
        <option {if $puertas eq "5"} selected="selected"{/if} value="5">5 Doors</option>
        <option {if $puertas eq ""} selected="selected"{/if} value="">&lt; Select Doors &gt;</option>
      </select> 
      *</td>
  </tr>
  <tr>
  ...
  <tr>
    <td align="left" class="subtituloWeb3">Transmission:</td>
    <td align="left" class="normalContenido"><select name="transmision" class="texto_gen" id="transmision">
        <option {if $transmision eq "Automatic"} selected="selected"{/if} value="Automatic">Automatic</option>
        <option {if $transmision eq "Manual"} selected="selected"{/if} value="Manual">Manual</option>
        <option {if $transmision eq ""} selected="selected"{/if} value="">&lt; Select Transmission &gt;</option>
      </select> 
      *</td>
  </tr>
  <tr>
    <td align="left" class="subtituloWeb3">Exterior Color:</td>
    <td align="left" class="normalContenido">
    <select name="color" class="texto_gen" id="color" >
    <option {if $color eq ""} selected="selected"{/if} value="">&lt; Select Color &gt;</option>
    <option {if $color eq "Beige"} selected="selected"{/if}  value="Beige">Beige</option>
    <option {if $color eq "Black"} selected="selected"{/if}  value="Black">Black</option>
    <option {if $color eq "Blue"} selected="selected"{/if}  value="Blue">Blue</option>
    <option {if $color eq "Brown"} selected="selected"{/if}  value="Brown">Brown</option>
    <option {if $color eq "Burgundy"} selected="selected"{/if}  value="Burgundy">Burgundy</option>
    <option {if $color eq "Charcoal"} selected="selected"{/if}  value="Charcoal">Charcoal</option>
    <option {if $color eq "Gold"} selected="selected"{/if}  value="Gold">Gold</option>
    <option {if $color eq "Gray"} selected="selected"{/if}  value="Gray">Gray</option>
    <option {if $color eq "Green"} selected="selected"{/if}  value="Green">Green</option>
    <option {if $color eq "Off White"} selected="selected"{/if}  value="Off White">Off White</option>
    <option {if $color eq "Orange"} selected="selected"{/if}  value="Orange">Orange</option>
    <option {if $color eq "Pink"} selected="selected"{/if}  value="Pink">Pink</option>
    <option {if $color eq "Purple"} selected="selected"{/if}  value="Purple">Purple</option>
    <option {if $color eq "Red"} selected="selected"{/if}  value="Red">Red</option>
    <option {if $color eq "Silver"} selected="selected"{/if}  value="Silver">Silver</option>
    <option {if $color eq "Tan"} selected="selected"{/if}  value="Tan">Tan</option>
    <option {if $color eq "Turquoise"} selected="selected"{/if}  value="Turquoise">Turquoise</option>
    <option {if $color eq "White"} selected="selected"{/if}  value="White">White</option>
    <option {if $color eq "Yellow"} selected="selected"{/if}  value="Yellow">Yellow</option></select> 
    *</td>
  </tr>
  <tr>
  ...
  <tr>
    <td>&nbsp;</td>
    <td align="left" class="normalContenido"><input name="envio" type="submit" class="componentes" id="button" onclick="javascript: return validaranuncio('&iquest;Est&aacute; seguro que desea guardar?');" value="Guardar" />
      &nbsp;
