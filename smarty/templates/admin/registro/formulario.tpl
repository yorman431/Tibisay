...
<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0" class="marco">
  ...
  <tr>
    <th align="center" class="titulo"><img src="/imagenes/cuadros.png" width="14" height="14" align="left" />{$accion}<img src="/imagenes/cuadritos.png" width="37" height="11" align="right" /></th>
  </tr>
  <tr>
    <td align="center" class="subtituloWeb3"><form action="" method="post" name="form1" id="form1" onsubmit="MM_validateForm('cedula','','RisNum','nombre','','R','apellido','','R','correo','','RisEmail','celular','','RisNum','telefono','','NisNum','login2','','R','clave2','','R','confirmar','','R');return document.MM_returnValue">
                <table border="0" align="center" cellpadding="0" cellspacing="0" width="60%">
                  ...
                  <tr>
                        ...
                        <td align="left" class="normalContenido"><input value="{$login}" onkeypress="javascripts: return validarletrasnum(event);" name="login2" type="text" id="login2" size="40" maxlength="20" />
                        *</td>
                      </tr>
                      <tr>
                        <td align="left" class="subtituloWeb3">Clave:</td>
                        <td align="left" class="normalContenido"><input onkeypress="javascripts: return validarletrasnum(event);" name="clave2" type="password" id="clave2" size="40" maxlength="20" />
                        *</td>
                      </tr>
                      <tr>
                        <td align="left" class="subtituloWeb3">Confirmar Clave:</td>
                        <td align="left" class="normalContenido"><input onkeypress="javascripts: return validarletrasnum(event);" name="confirmar" type="password" id="confirmar" size="40" maxlength="20" />
                        *</td>
                      </tr>
                      <tr>
              ...
              <input {if $publicidad eq "no"}checked="checked"{/if} type="radio" name="publicidad" id="radio2" value="no" /></td>
                       ...
                       <tr>
                        ...
                        <td align="left" class="normalContenido"><select name="medio" id="medio">
                          ...
                          <option {if $medio eq "Periodico"} selected='selected' {/if} value="Periodico">Nuestro Peri&oacute;dico</option>
                       ...
                       <tr>
                         <td colspan="2" align="left" class="normalContenido">Si 
                           <input type="radio" name="acepto" id="Si" value="Si" />
                           No
                           <input name="acepto" type="radio" id="No" value="No" checked="checked" />
                         acepto los <a class="noticia" target="_blank" href="/contenido.php?cont=19">t&eacute;rminos y condiciones</a> establecidos por CompraTuTicket.com.ve</td>
                       </tr>
                       <tr>
                        <td colspan="2" align="center" class="normalContenido"><input onclick="javascript: return validarcombos3();" type="submit" name="envio" id="envio" value="Registrarse" />
                           &nbsp;&nbsp;
                           <input type="button" name="Cancelar" id="Cancelar" value="Cancelar" onclick="javascript: location.href='index.php'" /> 
