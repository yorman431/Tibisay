...
<table width="96%" border="0" align="center" cellpadding="0" cellspacing="0" class="normal">
    ...
    <td align="center"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr> {section name=i loop=$listado}
        <td width="10%" align="center" class="normalContenido2" valign="top">
          <a href="/imagenes/publicidad/{$listado[i].directorio_dir}" title="{$listado[i].nombre_dir}" rel="lightbox[roadtrip]" >
            <img border="0" src="/imagenes/publicidad/{$listado[i].directorio_dir}" style=" width:150px; height:75px;" class="fotos" />
          </a><br />
          {$listado[i].nombre_dir}
          <a onclick="javascript: return confirmar('¿Está seguro que desea eliminar la imagen?');" href="imagen_borrar.php?id={$listado[i].id_dir}&amp;back={$id}&amp;tabla=publicidad">
  ...
  <td width="25%" align="center"><a href="/admin/panel_central.php">Panel <img src="/imagenes/atras.png" width="25" height="25" border="0" align="absmiddle" /></a></td>
    <td width="50%" align="center"><a href="/admin/publicidad">&nbsp;Atrás <img src="/imagenes/atras.png" width="25" height="25" border="0" align="absmiddle" /></a></td>
