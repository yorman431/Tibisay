    ...
    <table width="98%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <table width="90%" border="0" cellpadding="0" cellspacing="0" align="center">
          ...
          <tr>
            <td align="left" width="15%" class="normalContenido">Airport:</td>
            <td class="normalContenido" width="75%"><input type="text" name="airport" class="normalContenido" size="71" value="{$airport}"></td>
          </tr>
          <tr>
            <td align="left" width="15%" class="normalContenido">Transfer:</td>
            <td class="normalContenido" width="75%">
              <select name="traslado">
                <option {if $traslado == 'To Airport'}selected {/if} value="To Airport">To Airport</option>
                <option {if $traslado == 'From Airport'}selected {/if} value="From Airport">From Airport</option>
              </select>
            </td>
          </tr>
          <tr>
            <td align="left" width="15%" class="normalContenido">Return Trip:</td>
            <td class="normalContenido" width="75%">
              <select name="retorno">
                <option {if $retorno == 'Yes'}selected {/if} value="Yes">Yes</option>
                <option {if $retorno == 'No'}selected {/if} value="No">No</option>
              </select>
            </td>
          </tr>
          <tr>
            <td align="left" width="15%" class="normalContenido">Airline:</td>
            <td class="normalContenido" width="75%"><input type="text" name="aerolinea" class="normalContenido" size="71" value="{$aerolinea}"></td>
          </tr>
          <tr>
            <td align="left" width="15%" class="normalContenido">Fly Number:</td>
            <td class="normalContenido" width="75%"><input type="text" name="vuelo" class="normalContenido" size="71" value="{$vuelo}"></td>
          </tr>
          <tr>
            <td align="left" width="15%" class="normalContenido">Passagers:</td>
            <td class="normalContenido" width="75%"><input type="number" name="pasajero" class="normalContenido" size="71" value="{$pasajero}"></td>
          </tr>
          <tr>
...
<!-- InstanceEndEditable --></td>
  ...
  <td width="25%" align="center"><a href="/admin/panel_central.php">Panel <img src="/imagenes/atras.png" width="25" height="25" border="0" align="absmiddle" /></a></td>
    <td width="50%" align="center"><a href="/admin/reservas2">&nbsp;Back <img src="/imagenes/atras.png" width="25" height="25" border="0" align="absmiddle" /></a></td>
