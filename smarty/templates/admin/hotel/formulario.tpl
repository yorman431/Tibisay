          ...
          <tr>
            <td align="right" class="tituloWeb"><table width="60%" border="0" align="center" cellpadding="0" cellspacing="0">
              {$mensaje}
                ...
                <tr>
                  <td><span class="subtituloWeb3">Edad Niños:</span></td>
                  <td>Desde <input type="number" name="desdechd" min="0" value="{$desdechd}"> Hasta <input type="number" name="hastachd" value="{$hastachd}" min="0"></td>
                </tr>
