142
a:4:{s:8:"template";a:1:{s:20:"catalogo_crucero.tpl";b:1;}s:9:"timestamp";i:1421776386;s:7:"expires";i:1421779986;s:13:"cache_serials";a:0:{}}<!DOCTYPE html>
...
================================================== -->
 ...
 <div class="container-fluid">
	...
	<!-- InstanceBeginEditable name="contenido" --><a name="next" id="next"></a>
       <h1>Viajes en Crucero Reserva ya!</h1>
       <div id="panel_cruceros"> 
       		       		<div class="modulo_cruceros"><a name="Antillas y Caribe Sur Buque Monarch " href="crucero_detalle.php?id=1">
            <img class="opacidad" src="/imagenes/crucero/1402928332.jpg" width="320" height="400" alt="Antillas y Caribe Sur Buque Monarch " border="0" longdesc="
	CRUCERO ANTILLAS Y CARIBE SUR

	Pullmantur - Buque Monarch - 7 noches

	Saliendo desde La Guaira, Venezuela.

	Ruta:&nbsp;La Guaira (Venezuela) - Cura&ccedil;ao- Col&oacute;n (Panam&aacute;) - &nbsp;Cartagena de Indias (Colombia) - Aruba -&nbsp;La Guaira (Venezuela).

	
" /></a></div>
                   		<div class="modulo_cruceros"><a name="Caribe Tropical Buque Horizon" href="crucero_detalle.php?id=3">
            <img class="opacidad" src="/imagenes/crucero/1402928390.jpg" width="320" height="400" alt="Caribe Tropical Buque Horizon" border="0" longdesc="
	Crucero Caribe Tropical

	Pullmantur - Buque Horizon - 7 noches

	Saliendo desde la Isla de Margarita, Venezuela.

	Ruta: Margarita (Venezuela) - Santo Domingo (Rep. Dominicana) - La Romana (Rep. Dominicana) - &nbsp;Philipsburg (St. Maarten) - Pointe A Pitre (Guadalupe) - Fort De France (Martinica) -&nbsp;Margarita (Venezuela).

	
" /></a></div>
                   		<div class="modulo_cruceros"><a name="Brisas del Mediterráneo Buque Sovereign " href="crucero_detalle.php?id=4">
            <img class="opacidad" src="/imagenes/crucero/1402928519.jpg" width="320" height="400" alt="Brisas del Mediterráneo Buque Sovereign " border="0" longdesc="
	Crucero Brisas del Mediterr&aacute;neo

	Pullmantur - Buque Sovereign - 7 noches

	Saliendo desde Barcelona, Espa&ntilde;a.

	Ruta: Barcelona (Espa&ntilde;a) - T&uacute;nez - N&aacute;poles - &nbsp;Civitavecchia (Roma) - La Spezia (Florencia/Pisa) - Vilefranche (M&oacute;naco/Montecarlo) -&nbsp;Barcelona (Espa&ntilde;a).

	
" /></a></div>
                   		<div class="modulo_cruceros"><a name="Capitales Bálticas Buque Empress" href="crucero_detalle.php?id=5">
            <img class="opacidad" src="/imagenes/crucero/1402928542.jpg" width="320" height="400" alt="Capitales Bálticas Buque Empress" border="0" longdesc="
	Crucero Capitales B&aacute;lticas

	Pullmantur - Buque Empress - 7 noches

	Saliendo desde Malm&ouml;, Copenhague.

	Ruta: Malm&ouml; (Copenhague) - Wismar (Berl&iacute;n) - Nyn&auml;shamn (Estocolmo) - Helsinki - San Petersburgo - Tallin (Estonia).

	
" /></a></div>
                   		<div class="modulo_cruceros"><a name="Fiordos del Norte" href="crucero_detalle.php?id=6">
            <img class="opacidad" src="/imagenes/crucero/1402929681.jpg" width="320" height="400" alt="Fiordos del Norte" border="0" longdesc="
	...
	Ruta: Melm&ouml; (Copenhague) - Stavanger -&nbsp;Bergen&nbsp;- &nbsp;Fl&aring;m - Hellesylt - Geiranger - &Aring;lesund - Trondheim.

	
" /></a></div>
                   		<div class="modulo_cruceros"><a name="Crucero por Las Bahamas" href="crucero_detalle.php?id=7">
            <img class="opacidad" src="/imagenes/crucero/1402928617.jpg" width="320" height="400" alt="Crucero por Las Bahamas" border="0" longdesc="
	CRUCERO POR LAS BAHAMAS

	Royal Caribbean - Buque - 5 d&iacute;as y 4 noches

	Saliendo desde Miami, Florida. Estados Unidos.

	Ruta:&nbsp;Miami, Florida - Nassau, Bahamas&nbsp;- Cococay, Bahamas - &nbsp;Key West, Florida - Miami, Florida.
