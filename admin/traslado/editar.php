...
$traslado->asignar_valores_admin2($_GET['id']);
$traslado->editar_admin();
...
$smarty->assign("costo", $traslado->costo);
$smarty->assign("ruta", $traslado->ruta);
$smarty->assign('costo_nino', $traslado->costo_nino);
$smarty->assign('condiciones', $traslado->condiciones);
$smarty->assign("accion", $traslado->accion);
$smarty->display('admin/traslado/formulario.tpl');
