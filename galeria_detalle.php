...
$imagen=new Galeria;
$imagen->mostrar_imagenes("galeria");
...
$smarty->assign("accion", "Galer&iacute;a de ".$imagen->nombre);
$smarty->assign("msj_boletos", $msj_boletos);
$smarty->assign("descripcion", substr($imagen->limpiar_metas($imagen->descripcion,""), 0, 200));
$smarty->assign("claves", substr($imagen->limpiar_metas($imagen->descripcion,""), 0, 200));
