    ...
    for (i=0; i<(args.length-2); i+=3) { test=args[i+2]; val=document.getElementById(args[i]);
      if (val) { nm=val.name; if ((val=val.value)!="") {
        if (test.indexOf('isEmail')!=-1) { p=val.indexOf('@'); p=val.indexOf('.');
          if (p<1 || p==(val.length-1)) errors+='- '+nm+' debe contener una direcci�n de e-mail v�lida.\n';
...
function validarnoticia(mensaje){
	if (document.form1.categoria.value==""){
		alert("Para poder hacer el env�o, debe seleccionar una Categor�a");
	 	return false;
	}
	if (document.form1.titulo.value==""){
		alert("Para poder hacer el env�o, debe insertar un T�tulo!");
	 	return false;
	}
	if (document.form1.subtitulo.value==""){
		alert("Para poder hacer el env�o, debe insertar un Subt�tulo!");
	 	return false;
	}
	if (document.form1.fecha.value==""){
		alert("Para poder hacer el env�o, debe seleccionar una Fecha!");
	 	return false;
	}
	if (document.form1.autor.value==""){
		alert("Para poder hacer el env�o, debe insertar un Autor!");
	 	return false;
	}
	
	var editor = CKEDITOR.instances['contenido'].getData().replace(/<[^>]*>/gi, '');
    if (!editor.length){
    	alert("Para poder hacer el env�o, debe insertar un Contenido a la Noticia!");
		return false;
    }
...
function validarcombos(){
	...
	alert("Para poder hacer el env�o, debe seleccionar una categor�a y una subcategor�a");
	 return false;
	}
	return confirmar('�Est� seguro que desea guardar?');
}
...
function validarcontenido(mensaje){
	...
	var editor = CKEDITOR.instances['contenido'].getData().replace(/<[^>]*>/gi, '');
    if (!editor.length){
    	alert("Para poder hacer el env�o, debe llenar el Contenido!");
		return false;
    }
...
function validarcombos3(){
	if (document.form1.estado.value==""){
		alert("Para poder hacer el env�o, debe seleccionar un estado");
	 	return false;
	}
	
	if (document.form1.municipio.value==""){
		alert("Para poder hacer el env�o, debe seleccionar un municipio");
	 	return false;
	}
	
	if (document.form1.No.checked==true){
		alert("Para poder hacer el env�o, debe aceptar los terminos y condiciones!");
		return false;
...
function validar_pago(){
	if (document.form1.pedido.value==""){
		alert("Para poder hacer el env�o, debe seleccionar un pedido, si no tiene debe generar uno!");
	 	return false;
	}
...
/** si no recolocamos, solo ocultamos las im�genes **/
...
function validar_insertar_plan(formulario){
	if(document.getElementById('maxadultos'+formulario).value == ""){
		alert("Para poder hacer el env�o, debe insertar el m�ximo de adultos");
	 	return false;
	}
	
	if(document.getElementById('nombre_plan'+formulario).value == ""){
		alert("Para poder hacer el env�o, debe insertar el nombre del plan");
	 	return false;
	}
	
	if(document.getElementById('maxAdc'+formulario).value == ""){
		alert("Para poder hacer el envío, debe insertar una la cantidad máxima de huespedes en esta habitación");
	 	return false;
	}

	if(document.getElementById('precioAdc'+formulario).value == ""){
		alert("Para poder hacer el envío, debe insertar el precio del huesped adicional");
	 	return false;
	}
	
	if(document.getElementById('precio_plan'+formulario).value == ""){
		alert("Para poder hacer el env�o, debe insertar el precio");
	 	return false;
	}
	
	if(document.getElementById('prioridad'+formulario).value == ""){
		alert("Para poder hacer el env�o, debe insertar numero para ordenar");
	 	return false;
	}
...
function validar_insertar_rango(){
	...
	if(document.getElementById('categoria_nuevo').value == ""){
		alert("Para poder continuar, debe seleccionar una categor�a");
	 	return false;
	}
	...
	if(document.getElementById('precio_nuevo').value == ""){
		alert("Para poder hacer el env�o, debe insertar una tarifa");
	 	return false;
	}
