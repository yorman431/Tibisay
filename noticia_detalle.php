...
$noticia2->accion="Últimas Noticias";
...
$smarty->assign("descripcion", substr($noticia->limpiar_metas($noticia->contenido,""), 0, 140));
$smarty->assign("claves",substr($noticia->limpiar_metas($noticia->contenido,""), 0, 140));
